...
IHTab_Beta.fVisible(true);
//
// Change "Custom Info" text to customize tab title
IHTab_Beta.fSetTitle( "Beta" );
...
//
Entry = new TabEntry_Object( "Title 1->>>>  Beta Tab" );             // Sets title for entry
Entry.fAddLink( "Link 1", "url1" );                   // Adds link to entry
Entry.fAddLink( "Link 2", "url2" );                   // Adds another link
IHTab_Beta.fAddEntry( Entry );
...
IHTab_Beta.fAddEntry( Entry );                      // Adds entry to tab

Entry = new TabEntry_Object( "Title 3" );             // Sets title for entry
Entry.fAddLink( "Link 3", "url3" );                   // Adds link to entry
Entry.fAddLink( "Link 4", "http://www.google.com" );                   // Adds link to entry
List = new List_Object();                             // Creates new listbox
List.fSetTitle( "Listbox Title" );                    // Sets title for listbox
List.fAddItem( "Item 3 Title", "../hello.html" );              // Adds item to listbox
List.fAddItem( "Item 4 Title", "http://www.google.com" );              // Adds item to listbox
Entry.fAddList( List );                               // Adds listbox to entry
IHTab_Beta.fAddEntry( Entry );
